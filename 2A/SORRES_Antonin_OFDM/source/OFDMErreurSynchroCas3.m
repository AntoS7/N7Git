...
port_actives=16;
interPrefixe=2*3;
erreursynch=8; %préfixe cyclique + 2
...
%Démodulation 
SignalSortiebis=reshape(SignalSortieCanal,size(Xepref));
% erreur de synchro
tampon = SignalSortiebis(:,1:erreursynch-1);
SignalSortiebis(:,1:erreursynch-1)=[];
SignalSortiebis=[SignalSortiebis tampon];
